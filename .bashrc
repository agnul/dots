...
#export MW_HOME=${HOME}/opt/weblogic

export PATH=${HOME}/.rbenv/bin:${HOME}/bin:${GOPATH}/bin:${HOME}/opt/google_appengine:${ANT_HOME}/bin:${M2_HOME}/bin:/bin:${GOROOT}/bin:${SCALA_HOME}/bin:${PATH}:${CATALINA_HOME}/bin:${GRADLE_HOME}/bin:${HOME}/.cargo/bin
